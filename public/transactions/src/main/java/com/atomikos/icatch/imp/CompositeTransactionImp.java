...
class CompositeTransactionImp extends AbstractCompositeTransaction implements FSMEnterListener
{
	...
	private boolean localSiblingsTerminatedCalled;
    ...
    CompositeTransactionImp ( TransactionService txservice ,
            ...
            CoordinatorImp coordinator ) throws IllegalStateException
    {
        ...
        this.localSiblingsTerminatedCalled = false;
	...
	private void incLocalSiblingsTerminated() {
		if (!localSiblingsTerminatedCalled) {			
			coordinator.incLocalSiblingsTerminated();
			localSiblingsTerminatedCalled = true;
		}
	}
