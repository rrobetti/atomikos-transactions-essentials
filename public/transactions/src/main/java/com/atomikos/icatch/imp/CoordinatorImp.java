        ...
        FSMEnterListener, FSMTransitionListener
{
            ...
            HeurMixedException, SysException
    {
        ...
        if (hasActiveSiblings()) {
        	throw new RollbackException ( "Transaction is still active - prepare not allowed" );
        }
    ...
    {
    	if (onePhase && hasActiveSiblings()) {
            throw new RollbackException ( "Transaction is still active - commit not allowed" );
    	}
    	synchronized ( fsm_ ) {
            ...
            java.lang.IllegalStateException
    {
        ...
        if (hasActiveSiblings()) {
        	return; //let transaction time out + rollback locally
        }
