...
public class DefaultCompositeTransactionManager implements CompositeTransactionManager,
        SubTxAwareParticipant
{
    private static final Logger LOGGER = LoggerFactory.createLogger(DefaultCompositeTransactionManager.class);

    private Map<Thread, Stack<CompositeTransaction>> threadtotxmap_;
    private Map<CompositeTransaction, Thread> txtothreadmap_;


    public DefaultCompositeTransactionManager()
    {
