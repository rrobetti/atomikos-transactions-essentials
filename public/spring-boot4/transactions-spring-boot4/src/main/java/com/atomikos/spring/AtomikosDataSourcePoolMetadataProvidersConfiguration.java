...
public class AtomikosDataSourcePoolMetadataProvidersConfiguration {
	...
	@Configuration
	@ConditionalOnClass(AtomikosNonPoolingDataSourceBean.class)
	static class AtomikosNonPoolingDataSourceBeanMetadataProviderConfiguration {

		@Bean
		public DataSourcePoolMetadataProvider atomikosNonPoolingDataSourceBeanMetadataProvider() {

			return (dataSource) -> {
				AtomikosNonPoolingDataSourceBean atomikosDataSource = DataSourceUnwrapper.unwrap(dataSource, AtomikosNonPoolingDataSourceBean.class);
				if (atomikosDataSource != null) {
					return new AtomikosNonPoolingDataSourceBeanMetadata(atomikosDataSource);
				}
				return null;
			};
		}
