...
class SampleAtomikosApplicationTests {
    ...
    @Test
    void testTransactionRollbackWithoutSpringBoot4JtaAutoConfiguration(CapturedOutput output) throws Exception {
        SampleAtomikosApplication.main("--spring.autoconfigure.exclude=com.atomikos.spring.AtomikosAutoConfiguration");
