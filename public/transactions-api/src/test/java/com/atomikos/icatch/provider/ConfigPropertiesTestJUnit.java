...
public class ConfigPropertiesTestJUnit {
	...
	@Test
	public void testFeatureFlagReturnsFalseIfNotSetExplicitly() throws Exception {
		assertFalse(props.getFeatureFlag("someFeatureId"));
	}
	
	@Test
	public void testFeatureFlagReturnsTrueIfSetExplicitly() throws Exception {
		props.setProperty("com.atomikos.icatch.feature.someFeatureId", "true");
		assertTrue(props.getFeatureFlag("someFeatureId"));
	}
}
