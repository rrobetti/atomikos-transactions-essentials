...
public final class ConfigProperties {
    ...
    private static final String FEATURE_FLAG_PREFIX = "com.atomikos.icatch.feature.";
    ...
    public boolean getFeatureFlag(String featureId) {
    	try {
    		return getAsBoolean(FEATURE_FLAG_PREFIX + featureId);
