...
public final class Configuration
{
    ...
    private static Map<String, RecoverableResource> resources_ = new HashMap<> ();
    ...
    public static RecoverableResource getResource ( String name )
    {
        ...
        if ( name != null ) res = resources_.get ( name );
        return res;
    }
    ...
    public static Collection<RecoverableResource> getResources ()
    {
        ...
        return new ArrayList<RecoverableResource>(resources_.values());
    }
	...
	private static void notifyAfterInit() {
		...
		for (RecoverableResource r : resources_.values() ) {
