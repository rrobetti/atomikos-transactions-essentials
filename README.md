...
* **Connection pooling for JDBC and JMS** - so you get maximum **performance**. Pooling can also be disabled per datasource if needed (e.g., for testing, debugging, or serverless environments).
