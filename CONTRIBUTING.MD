...
We're happy with all the help we can get (and you want to give), but we think that the following would be the most useful contributions:
 ...
 - Give us your feedback by a [one-on-one zoom call](https://calendly.com/guypardon/open-source-feedback)
...
If you use an agent like Codex or Claude Code while working on this codebase, please follow the guidance in `USING_AGENTS.md`.
